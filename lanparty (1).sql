...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 15 dec 2017 om 10:38
...
CREATE TABLE `application` (
  ...
  `applicationCB` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `participate` (
  `userId` int(11) NOT NULL,
  `applicationTournooi` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `tournooi`
  MODIFY `tournooiId` int(11) NOT NULL AUTO_INCREMENT;
--
