...
<head>
<title>LeagueOfLegendsTournooi</title>
<meta charset="utf-8">
...
<div class="topspacer bgded overlay" style="background-image:url('../images/demo/backgrounds/06.jpg');">
        ...
        <ul class="clear">
          ...
          <li class="active"><a class="drop" href="tournooien.php">Tournooien</a>
            <ul>
              ...
              <li class="active"><a href="leagueoflegends.php">League of legends</a></li>
  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <h1>League of legends</h1>
        ...
        <button type="submit" name="aanmeldenLeague" value="aanmeldenLeague" style=" color:#FFFFFF; background-color:#00CCBD; border-color:transparent; padding:8px 18px 10px; text-transform:uppercase; font-weight:700; cursor:pointer;">Aanmelden</button>
        <!--niks aan gekoppeld-->
