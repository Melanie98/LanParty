  ...
  <main class="hoc container clear">
    ...
    <div class="content">
      ...
      <h1>Overwatch</h1>
        ...
        <button type="submit" name="aanmeldenOverwatch" value="aanmeldenOverwatch" style=" color:#FFFFFF; background-color:#00CCBD; border-color:transparent; padding:8px 18px 10px; text-transform:uppercase; font-weight:700; cursor:pointer;">Aanmelden</button>
        <!--niks aan gekoppeld-->
